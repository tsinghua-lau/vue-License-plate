...
export default {
  ...
  watch: {
      ...
      "args.changedseed": function(a){
          this.numberArray = this._rebuildNumberArray(this.args.number, this.numberArray.length/*要保证与原生长度一致*/);
  ...
  methods: {
    ...
    //////// 以下是工具类函数
    // 将车牌号码，生成一个车牌字符数组
     _rebuildNumberArray(updateNumber, originLength){
...
_isEnergyNumber(number) {
  ...
  NumberView,
    keyboardView
    //  "mixed-keyboard": require("../../src/components/MixedKeyboard.vue")
  },
}
